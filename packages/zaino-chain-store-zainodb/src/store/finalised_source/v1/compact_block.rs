...
use zaino_primitives::types::{ShieldedPool, TreeSize};
...
fn assemble_compact_block(
    ...
    Ok(zaino_primitives::types::CompactBlock {
        ...
        chain_metadata: zaino_primitives::types::ChainMetadata {
            sapling_tree_size: TreeSize::from(commitment_tree_data.sizes().sapling()),
            orchard_tree_size: TreeSize::from(commitment_tree_data.sizes().orchard()),
            ironwood_tree_size: TreeSize::from(commitment_tree_data.sizes().ironwood()),
        },
    })
}
...
pub(crate) fn compact_block_from_indexed(
    ...
    Ok(zaino_primitives::types::CompactBlock {
        ...
        transactions,
        chain_metadata: zaino_primitives::types::ChainMetadata {
            sapling_tree_size: TreeSize::from(sizes.sapling()),
            orchard_tree_size: TreeSize::from(sizes.orchard()),
            ironwood_tree_size: TreeSize::from(sizes.ironwood()),
        },
    })
}
