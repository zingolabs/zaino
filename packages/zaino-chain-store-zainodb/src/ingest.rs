...
fn block_counters() -> &'static BlockCounters {
    ...
    COUNTERS.get_or_init(|| {
        ...
        BlockCounters {
            transactions: metrics::counter!(SYNC_FETCHED_TRANSACTIONS_TOTAL),
            transparent_inputs: metrics::counter!(SYNC_FETCHED_TRANSPARENT_INPUTS_TOTAL),
            transparent_outputs: metrics::counter!(SYNC_FETCHED_TRANSPARENT_OUTPUTS_TOTAL),
            sapling_spends: metrics::counter!(SYNC_FETCHED_SAPLING_SPENDS_TOTAL),
            sapling_outputs: metrics::counter!(SYNC_FETCHED_SAPLING_OUTPUTS_TOTAL),
            orchard_actions: metrics::counter!(SYNC_FETCHED_ORCHARD_ACTIONS_TOTAL),
            ironwood_actions: metrics::counter!(SYNC_FETCHED_IRONWOOD_ACTIONS_TOTAL),
        }
    })
}
