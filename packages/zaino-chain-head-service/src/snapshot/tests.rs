...
//! whatever has been trimmed or rewound. [`invariants`] checks the struct's
//! documented invariants against its private fields, and [`properties`] runs
//! that check over random move sequences.
