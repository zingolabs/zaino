...
> [docs/release/pipeline.md](https://github.com/zingolabs/zaino/blob/dev/docs/release/pipeline.md). This is the record of
...
superseded by [ADR-0016](0016-changeset-derived-release-pipeline.md)
