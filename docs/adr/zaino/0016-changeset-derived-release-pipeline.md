...
Supersedes [ADR-0015](0015-periodic-release-flow.md) and, through it, the
org-scoped [003](../003-zaino-branching-versioning-and-release-strategy.md). The machinery lands inert behind the repo variable
...
- Release credentials concentrate in CI. The inventory, exposure posture, and
  ...
  [docs/release/implementation.md](https://github.com/zingolabs/zaino/blob/dev/docs/release/implementation.md) § Trust
...
- The full specifications live in `docs/release/`:
  [pipeline.md](https://github.com/zingolabs/zaino/blob/dev/docs/release/pipeline.md) (policy),
  [changeset-format.md](https://github.com/zingolabs/zaino/blob/dev/docs/release/changeset-format.md) (contributor
  contract), [implementation.md](https://github.com/zingolabs/zaino/blob/dev/docs/release/implementation.md) (architecture).
